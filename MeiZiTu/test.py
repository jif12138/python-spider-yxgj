...
def login(url):
    ...
    data={"phone":"15318838316","password":"Jim123456789","content":content,"mobileOS":"web","version":version,"manufacturer":manufacturer}
    # print(data)
    ...
    if r.status_code==200:
        # print(r.json())
        message=r.json()
        temp_headers["Cookie"]="id="+str(message["id"])+"; session_id="+message["session_id"]+"; username="+str(message["username"])+"; phone_number="+str(message["phone_number"])+"; type="+message["type"]+"; assessment="+str(message["roleList"]["assessment"])+"; competition_audit="+str(message["roleList"]["competition_audit"])+"; course="+str(message["roleList"]["course"])+"; learning="+str(message["roleList"]["learning"])+"; mark="+str(message["roleList"]["mark"])+"; student="+str(message["roleList"]["student"])+"; subject="+str(message["roleList"]["subject"])
